...
import DigitalNexus from "./Descriptions/DigitalNexus";

import Contrivers from "./Descriptions/Contrivers";
export default function WhereIHaveWorked() {
  ...
  const [DescriptionJob, setDescriptionJob] = React.useState("Contrivers");
  return (
...
const CompaniesBar = props => {
  const [barPosition, setBarPosition] = React.useState<Number>(24); // Green bar position by the default it's -20px
  ...
  return (
    ...
    >
      {/* // ? left bar Holder */}
      <div
        className="hidden md:block bg-gray-500 relative h-20 w-34 md:h-[150px] translate-y-1 md:w-0.5 rounded md:order-1 order-2"
      >
        {/* // ? animated left bar */}
        <motion.div
      ...
      <div className="flex flex-col md:order-2 order-1 space-y-1 pl-8 md:pl-0 ">
        ...
        <CompanyButton
            ...
            CompanyName="Contrivers"
            BarPosition={24}
            BarAvobePosition={1}
            DescriptionJob="Contrivers"
